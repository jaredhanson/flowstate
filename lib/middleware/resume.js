...
module.exports = function(dispatcher, store, options) {
  ...
  return function resumeState(req, res, next) {
    ...
    function dispatch(name) {
      ...
      // NOTE: Once we have arrived at this point, the middleware chain
      //       processing the request is halted.  All further processing will
      //       be handled by the resume middleware chain of the flow, including
      //       error handling.
