  ...
  return function state(req, res, next) {
    ...
    swizzleRender(res, function(cb) {
      ...
      commit2(function(err, nstate) {
        ...
        if (!nstate.handle) {
          // The state was initialized using the redirect URL and optional state,
          // but never modified.  It can be carried forward on subsequent requests
          // by preserving those parameters.
